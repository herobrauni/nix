{
  ...
  den.hosts.x86_64-linux.alpha1 = {
    hostName = "alpha1";
    singleDisk.device = "/dev/vda";
    users.brauni = { };
  };
  den.hosts.x86_64-linux.axushost1 = {
    hostName = "axushost1";
    singleDisk.device = "/dev/vda";
    users.brauni = { };
  };
  ...
  den.hosts.x86_64-linux.onidel2 = {
    hostName = "onidel2";
    singleDisk.device = "/dev/vda";
    users.brauni = { };
  };
  ...
  den.hosts.x86_64-linux.hostc4 = {
    hostName = "hostc4";
    singleDisk.device = "/dev/sda";
    users.brauni = { };
  };
  den.hosts.x86_64-linux.hostc5 = {
    hostName = "hostc5";
    singleDisk.device = "/dev/sda";
    users.brauni = { };
  };
